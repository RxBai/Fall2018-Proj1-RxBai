...
To make use of more details in the data, we compare the most common words used by people from different categories. By doing so, some characteristics of happy moments associated with gender, parenthood, marital status, age and reflection period show up.
